...
unreg: 'Regístrese para usar esta función  Escribiendo:\n\n*/reg nombre.edad*\n\n🍭 Ejemplo : */reg Josue.17*',
restrict: '• Esta función está *deshabilitada*',
nsfw: '• En este grupo está prohibido el contenido +18'
}[type]
//if (msg) return conn.reply(m.chat, msg, m)
let tg = { quoted: m, userJid: conn.user.jid }
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: 'MultiBot-Beta', body: 'ADVERTENCIA', thumbnail: imgAdv, sourceUrl: global.canal }}}}, tg)
