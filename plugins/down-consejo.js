...
let img = 'https://telegra.ph/file/c375b2b38692ca110660b.jpg'
...
[mssg.botonA, `${usedPrefix + command}`],
[mssg.botonF, `${usedPrefix}estado`],
[mssg.botonC, `${usedPrefix}menu`]], null, fkontak)}
  
if (command == 'frase2' || command == 'phrase2') { 
let img = 'https://telegra.ph/file/8d3b2c5d321b20ee3a2b3.jpg'  
let list = (await axios.get(`https://raw.githubusercontent.com/MultiBot-OFC/MultiBot-MD/master/src/JSON/frase2.json`)).data  
...
//await conn.sendButton(m.chat, texto.trim(), wm, img, [[lenguajeMT.smsFras(), `${usedPrefix + command}`], [lenguajeMT.smsConMenu(), `${usedPrefix}menu`]], m, frep)} 
} catch (e) {
