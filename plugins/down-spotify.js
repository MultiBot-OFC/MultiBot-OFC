...
let frep = { contextInfo: { externalAdReply: {title: wm, body: author, sourceUrl: redesMenu, thumbnail: await(await fetch(multiMenu)).buffer() }}}
if (!text) return await conn.reply(m.chat, `${mssg.eTexto} *${usedPrefix + command} Erika lundmoen - yad*`, m) 
try {
...
${mssg.playBorded}${spty.data.name

${mssg.playBordec}${mssg.Artista}
${mssg.playBorded}${spty.data.artists}

${mssg.playBordec}${mssg.Enlace}
${mssg.playBorded}${linkDL}
${mssg.playBordeB}
