...
// Cuentas
const response = await fetch('https://raw.githubusercontent.com/MultiBot-OFC/MultiBot-MD/master/multibot_ofc.json')  
...
global.multiImg = [img, img2, img3, img4, img5].getRandom()
...
let enlace = { contextInfo: { externalAdReply: {title: wm, body: 'support group' , sourceUrl: canal, thumbnail: await(await fetch(multiImg)).buffer() }}}
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: 'Bot ', thumbnailUrl: multiImg, sourceUrl: canal }}}
